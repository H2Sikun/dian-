...
public:
    ...
    void clearData();
    void clearDayData(const string& dayStr);
    void showDayAllReservations(const string& dayStr);
    void adminReserveSeat(const string& user, const string& dayStr, int floor, int row, int col);
    void run();
